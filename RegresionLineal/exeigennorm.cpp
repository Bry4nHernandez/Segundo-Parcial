 ...
 *  datos = x_1 - promedio(x)*/
    ...
    /* A continuacion se hara una funcion para dividir los datos en conjuntos de datos
     * de entrenamiento y conjunto de datos prueba
     */
    ...
    std:: tuple<Eigen:: MatrixXd,Eigen:: MatrixXd,Eigen:: MatrixXd,Eigen:: MatrixXd> ExEigenNorm::TrainTestSplit( Eigen:: MatrixXd datos,float sizeTrain){
         ...
         * se pueden seleccionar las filas superiores para el conjunto de entrenamiento
         * indicando cuantas filas se desean, se seleccionan desde 0 (fila 0) hasta el
         * numero de filas indicado
         */

        Eigen:: MatrixXd entrenamiento=datos.topRows(filasTrain);

        /* Seleccionadas las filas superiores para el entrenamiento,se
         * seleccionan las 11 primeras columnas(columnas a la izquierda)
        ...
        /* Finalmente se retorna una tuple dada por el conjunto
...
/* Se implentan dos funciones para exportar a ficheros desde vector y
 * desde eigen  
 */
